...
--
-- Host: localhost    Database: cantinasenai
-- ------------------------------------------------------
...
CREATE TABLE `cantina` (
  `id_cantina` bigint NOT NULL AUTO_INCREMENT,
  `id_produto` bigint NOT NULL,
  `disponivel` tinyint(1) DEFAULT '1',
  PRIMARY KEY (`id_cantina`),
  KEY `id_produto` (`id_produto`),
  CONSTRAINT `cantina_ibfk_1` FOREIGN KEY (`id_produto`) REFERENCES `produto` (`id_produto`)
...
CREATE TABLE `pedido` (
  ...
  KEY `id_cantina` (`id_cantina`),
  KEY `FK9estgt6frorcbiblkbqruek29` (`id_produto`),
  CONSTRAINT `FK9estgt6frorcbiblkbqruek29` FOREIGN KEY (`id_produto`) REFERENCES `produto` (`id_produto`),
  CONSTRAINT `pedido_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`),
  CONSTRAINT `pedido_ibfk_2` FOREIGN KEY (`id_cantina`) REFERENCES `cantina` (`id_cantina`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-05-03  0:03:17
